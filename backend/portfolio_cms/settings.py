...
# We only allow the insecure fallback when DEBUG=True (local dev).
SECRET_KEY = os.environ.get('SECRET_KEY')

if not SECRET_KEY:
    # Allow fallback only in debug/development
    if os.environ.get('DEBUG', 'False') == 'True':
        SECRET_KEY = 'django-insecure-dev-fallback-key-change-me'
    else:
        raise RuntimeError('SECRET_KEY environment variable is required in production.')
elif SECRET_KEY.startswith('django-insecure') and os.environ.get('DEBUG', 'False') != 'True':
...
TEMPLATES = [
    ...
    # Templates directory (the frontend folder lives at the project root alongside backend)
