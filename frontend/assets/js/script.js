const staticBase = window.staticBase || '/static/';
...
const skillsData = {
    ...
    soft: [
        ...
        { name: 'Leadership', icon: 'https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/yarn.svg', percentage: 85 }
    ]
};
...
const projectsData = [
    ...
    {
        title: "BookMatch",
        description: "Intelligent book recommendation system that helps users discover new literature based on their reading preferences.",
        technologies: ["Python", "Machine Learning", "RS"],
...
const comradesData = [
    ...
    },
    {
        ...
        description: "A quick learner and gamer, always enjoys a new challenge, she is interested in data science and related projects, my dearest friend and colleague.",
    ...
    },
    {
        ...
        description: "Web developer with a passion for creating innovative user experiences and modern web applications. He is always exploring new technologies.",
            ...
            <div class="comrade-card">
                <div class="comrade-banner">
                    <div class="comrade-avatar">
                        <img src="${staticBase}${comrade.image}" alt="${comrade.name}" loading="lazy">
                    </div>
